...
/// [CustomExpansionContainer] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
...
/// to the [leading] and [trailing] properties of [CustomExpansionContainer].
///
/// {@tool dartpad}
...
class CustomExpansionContainer extends StatefulWidget {
  ...
  @override
  State<CustomExpansionContainer> createState() => _CustomExpansionContainerState();
}

class _CustomExpansionContainerState extends State<CustomExpansionContainer> with SingleTickerProviderStateMixin {
  ...
  Widget? _buildIcon(BuildContext context) {
    return RotationTransition(
      turns: _iconTurns,
      child: const Icon(Icons.arrow_drop_down,color: kExpansionBoxColor),
    );
  }
